...
struct AppearanceView: View {
	...
	@AppStorage("VexSign.sourcesShowUpdatesAsTab")
	private var _sourcesShowUpdatesAsTab: Bool = false

	@AppStorage("VexSign.showSourcesUpdateBadge")
	private var _showSourcesUpdateBadge: Bool = true

	@AppStorage("VexSign.shouldTintIcons")
	private var _shouldTintIcons: Bool = false

	@AppStorage("VexSign.shouldChangeIconsBasedOffStyle")
	private var _shouldChangeIconsBasedOffStyle: Bool = false

	@AppStorage("VexSign.userTintColor")
