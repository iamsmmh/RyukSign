...
struct DownloadBubbleView: View {
    ...
    private func saveBubblePosition(_ position: CGPoint) {
        UserDefaults.standard.set(position.x, forKey: "VexSign.downloadBubblePositionX")
        UserDefaults.standard.set(position.y, forKey: "VexSign.downloadBubblePositionY")
    }

    private func loadBubblePosition(in geometry: GeometryProxy) {
        let savedX = UserDefaults.standard.double(forKey: "VexSign.downloadBubblePositionX")
        let savedY = UserDefaults.standard.double(forKey: "VexSign.downloadBubblePositionY")
