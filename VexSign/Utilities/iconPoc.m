...
//    descriptor.appearance = 0;
	NSInteger style =
		[NSUserDefaults.standardUserDefaults integerForKey:@"VexSign.userInterfaceStyle"];
	NSInteger variant =
		[NSUserDefaults.standardUserDefaults integerForKey:@"VexSign.shouldTintIcons"];
	NSInteger lightDark =
		[NSUserDefaults.standardUserDefaults integerForKey:@"VexSign.shouldChangeIconsBasedOffStyle"];
...
static CGColorRef FRCreateCGColorFromHex(void) {
	NSString *hex =
		[NSUserDefaults.standardUserDefaults
			stringForKey:@"VexSign.userTintColor"];
