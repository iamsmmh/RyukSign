...
//  RyukSign
//
//  First-launch wizard: what RyukSign is, import a certificate, pick install method.
//
...
struct OnboardingView: View {
	...
	@AppStorage("RyukSign.onboardingCompleted") private var _completed = false
	@AppStorage("Feather.installationMethod") private var _installMethod = 0
	...
	private var _pageWelcome: some View {
		VStack(spacing: 16) {
			...
			Text(.localized("RyukSign uses your certificate to sign IPAs, then installs them over the local server or a pairing file. Nothing is uploaded."))
