...
//  RyukSign
//
//  Everything RyukSign throws away by itself: the apps that have already been signed or
...
final class CleanupManager: ObservableObject {
	...
	/// UserDefaults keys. The `Feather.` ones are shared with the older toggles in
	...
	enum Key {
		...
		static let enabled = "RyukSign.cleanup.enabled"
		/// Import → sign → install → cleanup in one go.
		static let oneTapInstall = "RyukSign.cleanup.oneTapInstall"

		static let deleteAfterInstall = "Feather.deleteAppAfterInstall"
		static let clearCache = "Feather.clearCacheAfterInstall"

		static let deleteSourceAfterSign = "RyukSign.cleanup.deleteSourceAfterSign"
		static let deleteSignedAfterSign = "RyukSign.cleanup.deleteSignedAfterSign"
		static let deleteDownloadedIPA = "RyukSign.cleanup.deleteDownloadedIPA"
		static let clearTemporary = "RyukSign.cleanup.clearTemporary"
		static let removeLeftovers = "RyukSign.cleanup.removeLeftovers"
		static let clearArchives = "RyukSign.cleanup.clearArchives"

		static let pendingApps = "Feather.installCleanupPending"
		static let lastRun = "RyukSign.cleanup.lastRun"
		static let lastFreed = "RyukSign.cleanup.lastFreed"
	}
