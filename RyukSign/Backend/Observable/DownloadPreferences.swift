...
enum DownloadPreferences {
	static let wifiOnlyKey = "RyukSign.downloads.wifiOnly"
	static let maxParallelKey = "RyukSign.downloads.maxParallel"
	static let resumeAfterGameModeKey = "RyukSign.downloads.resumeAfterGameMode"
...
private final class PathMonitor {
	...
	private let queue = DispatchQueue(label: "ryuksign.path")
